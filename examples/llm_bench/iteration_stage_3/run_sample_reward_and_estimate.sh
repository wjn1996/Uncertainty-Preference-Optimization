...
if [ "$DO_GENERATING" = "true" ]; then
    ...
    POLICY_MODEL_PATH=outputs/llm_bench/iteration_stage_2/policy_dpo/zephyr-7b-sft-full/lora/checkpoint-1500
...
if [ "$DO_REWARDING" = "true" ]; then
    ...
    # REWARD_MODEL_PATH=outputs/llm_bench/init_stage/rm/zephyr-7b-sft-full/lora/checkpoint-800
