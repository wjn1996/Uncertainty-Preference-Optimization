...
if __name__ == "__main__":
    ...
    dataset_info[args.new_pair_data_name_to_datasetinfo] = {
      "file_name": os.path.join(save_dir, "pair_train_data.json"),
      "ranking": True,
      "formatting": "sharegpt",
      "columns": {
...
"""
run script:
python3 examples/math_bench/all_iteration/merge_all_preference_data_from_all_iterations.py \
--data_path=data/MathStepDPO10k \
--iteration_total=3 \
--new_pair_data_name_to_datasetinfo=math_stepdpo_all_iter_pair
"""
