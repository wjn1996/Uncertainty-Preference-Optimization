...
from src.alignment.data.formatter import EmptyFormatter, FunctionFormatter, StringFormatter, ToolFormatter


if TYPE_CHECKING:
    from transformers import PreTrainedTokenizer

    from src.alignment.data.formatter import SLOTS, Formatter
