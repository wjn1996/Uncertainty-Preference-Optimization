...
import torch
from transformers import DataCollatorForSeq2Seq, DefaultDataCollator, PreTrainedTokenizerBase
...
class CLSDataCollatorWithPadding:
    r"""
    Data collator for cls data.
    """

    tokenizer: PreTrainedTokenizerBase
    max_length: Optional[int] = 3072
    ...
    def __call__(self, features):
        ...
        for f in features:
            ...
            if "token_type_ids" in f.keys():
                feature["token_type_ids"] = f["token_type_ids"]
